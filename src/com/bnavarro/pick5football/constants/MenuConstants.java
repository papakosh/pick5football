...
public class MenuConstants {
	...
	public static class MATCH_MENU{
		public static String NONE = "Pick None";
		public static String VIEW_GAME = "View Game Score";
		public static String PICK="Pick ";
	}
	
	public static class FILE_MENU{
		public static String SUBMIT_PICKS = "Submit Your Picks";
